...
describe("PLAYER METHODS", function() {
  describe("validateLocation", function() {
    const validateLocation = require("../game_logic/player_methods.js")
      .validateLocation;
    let player;
  ...
  describe("validateLocations", function() {
    let validateLocations = require("../game_logic/player_methods.js")
      .validateLocations;
    let player;
  ...
  describe("placeShip", function() {
    ...
    it("should throw an error if no direction is specified", function() {
      ...
      expect(handler).to.throw(
        "You left ouf the direction ! I need that for math!"
      );
    });
  });
});
